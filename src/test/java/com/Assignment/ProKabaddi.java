...
public class ProKabaddi {
	public static void main(String[] args) {
		...
		String position = driver.findElement(By.xpath("//div[@class='table-body']/descendant::p[text()='" + team
				+ "']/ancestor::div[@class='table-row-wrap']/descendant::p[@class='position']")).getText();
		String matchPlayed = driver
				.findElement(By.xpath("//div[@class='table-body']/descendant::p[text()='" + team
						+ "']/ancestor::div[@class='table-row-wrap']//div[@class='table-data matches-play']/p"))
				.getText();
		String matchWon = driver
				.findElement(By.xpath("//div[@class='table-body']/descendant::p[text()='" + team
						+ "']/ancestor::div[@class='table-row-wrap']//div[@class='table-data matches-won']/p"))
				.getText();
		String matchLost = driver.findElement(By.xpath("//div[@class='table-body']/descendant::p[text()='" + team
				+ "']/ancestor::div[@class='table-row-wrap']//div[@class='table-data matches-lost']/p"))
		.getText();
String matchTie = driver
		.findElement(By.xpath("//div[@class='table-body']/descendant::p[text()='" + team
				+ "']/ancestor::div[@class='table-row-wrap']//div[@class='table-data matches-draw']/p"))
		.getText();
String scoreDiff = driver
		.findElement(By.xpath("//div[@class='table-body']/descendant::p[text()='" + team
				+ "']/ancestor::div[@class='table-row-wrap']//div[@class='table-data score-diff']/p"))
		.getText();

List<WebElement> allform = driver.findElements(By.xpath("//div[@class='table-body']/descendant::p[text()='"
		+ team + "']/ancestor::div[@class='table-row-wrap']//div[@class='table-data form']//li/p"));
